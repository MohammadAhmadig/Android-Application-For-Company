...
public class CustomAdapter_Dehyari extends BaseAdapter implements Filterable
{
    ...
    public CustomAdapter_Dehyari(Context context, ArrayList<Contact> data)
    {
    ...
    public View getView (int position, View convertView, ViewGroup parent)
    {
        ...
        if (vi == null)
        {
            vi = inflater.inflate(R.layout.contact_item_dehyari, null);
            ...
            holder.txtAdmin = (TextView) vi.findViewById(R.id.contact_txtAdmin);
        ...
        if (data.size() > 0)
        {
            ...
            holder.txtAdmin.setText(tempValue.getAdmin());
